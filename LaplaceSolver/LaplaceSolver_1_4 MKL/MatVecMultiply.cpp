...
#pragma omp parallel for
    ...
    mkl_cspblas_scsrgemv( // (S)parse (CSR) (Ge)neral matrix (M)atrix-(V)ector product
        ...
        (const long long *)&N,               // Size of the matrix
        values,           // values array (MKL denotes this as "a")
        (const long long *)rowOffsets,       // rowOffsets array (MKL denotes this as "ia")
        (const long long *)columnIndices,    // columnIndices array (MKL denotes this as "ja")
